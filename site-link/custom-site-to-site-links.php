...
class Disciple_Tools_Strategy_Site_Links {
    public $type = 'disciple_tools_strategy';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Disciple Tools Strategy' );
        return $type;
    }
}
Disciple_Tools_Strategy_Site_Links::instance();
