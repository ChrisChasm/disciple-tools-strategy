...
class Disciple_Tools_Strategy_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = '' ) {
        if ( $post_type === 'contacts' || $post_type === 'starter_post_type' ){
            $tiles['disciple_tools_strategy'] = [ 'label' => __( 'Disciple Tools Strategy', 'disciple-tools-strategy' ) ];
            $tiles['a_beautiful_tile'] = [ 'label' => __( 'A Beautiful Tile', 'disciple-tools-strategy' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = '' ) {
        ...
        if ( $post_type === 'contacts' || $post_type === 'starter_post_type' ){
             ...
             */
            $fields['disciple_tools_strategy_text'] = [
                'name'        => __( 'Text', 'disciple-tools-strategy' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-strategy' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_strategy',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields['disciple_tools_strategy_multiselect'] = [
                'name' => __( 'Multiselect', 'disciple-tools-strategy' ),
                'default' => [
                    'one' => [ 'label' => __( 'One', 'disciple-tools-strategy' ) ],
                    'two' => [ 'label' => __( 'Two', 'disciple-tools-strategy' ) ],
                    'three' => [ 'label' => __( 'Three', 'disciple-tools-strategy' ) ],
                    'four' => [ 'label' => __( 'Four', 'disciple-tools-strategy' ) ],
                ],
                'tile' => 'disciple_tools_strategy',
                'type' => 'multi_select',
                'hidden' => false,
             ...
             */
            $fields['disciple_tools_strategy_keyselect'] = [
                'name' => 'Key Select',
                'type' => 'key_select',
                'tile' => 'disciple_tools_strategy',
                'default' => [
                    'first'   => [
                        'label' => _x( 'First', 'Key Select Label', 'disciple-tools-strategy' ),
                        'description' => _x( 'First Key Description', 'Training Status field description', 'disciple-tools-strategy' ),
                        'color' => '#ff9800'
                    ],
                    'second'   => [
                        'label' => _x( 'Second', 'Key Select Label', 'disciple-tools-strategy' ),
                        'description' => _x( 'Second Key Description', 'Training Status field description', 'disciple-tools-strategy' ),
                        'color' => '#4CAF50'
                    ],
                    'third'   => [
                        'label' => _x( 'Third', 'Key Select Label', 'disciple-tools-strategy' ),
                        'description' => _x( 'Third Key Description', 'Training Status field description', 'disciple-tools-strategy' ),
                        'color' => '#366184'
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ...
            //test fields
            $fields['number_test'] = [
                'name'        => __( 'Number field', 'disciple-tools-strategy' ),
                'type'        => 'number',
                'default'     => 0,
            ...
            $fields['number_test_private'] = [
                'name'        => __( 'Number field private', 'disciple-tools-strategy' ),
                'type'        => 'number',
                'default'     => 0,
                'tile'        => 'a_beautiful_tile',
                'private'     => true,
            ...
            $fields['contact_communication_channel_test'] = [
                'name'        => __( 'Communication Channel', 'disciple-tools-strategy' ),
            ...
            $fields['user_select_test'] = [
                'name'        => __( 'User Select', 'disciple-tools-strategy' ),
                'type'        => 'user_select',
                'tile'        => 'a_beautiful_tile'
            ];
            $fields['array_test'] = [
                'name'        => __( 'Array', 'disciple-tools-strategy' ),
                'type'        => 'array',
                'tile'        => 'a_beautiful_tile'
            ];
            ...
            $fields['date_test'] = [
                'name'        => __( ' Date Field', 'disciple-tools-strategy' ),
                'description' => '',
                'type'        => 'date',
                'default'     => '',
                'tile' => 'a_beautiful_tile'
            ...
            $fields['boolean_test'] = [
                'name'        => __( 'Boolean', 'disciple-tools-strategy' ),
                'type'        => 'boolean',
                'default'     => false,
            ];
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === 'contacts' || $post_type === 'starter_post_type' ) && $section === 'disciple_tools_strategy' ){
            /**
...
Disciple_Tools_Strategy_Tile::instance();
